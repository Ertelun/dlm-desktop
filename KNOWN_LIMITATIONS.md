# Known Limitations — First Public Beta

- First Public Beta shipping scope is **Windows x64**.
- ARM64 is **not** qualified for the first Beta.
- The first Beta is **unsigned** and may trigger Unknown Publisher / SmartScreen warnings.
- Distribution is a **ZIP package**, not an installer.
- The only canonical first-Beta binary source is `Ertelun/dlm-desktop` GitHub Releases.
