...
| Capability | DLsite | DMM/FANZA | Public wording |
|---|---|---|---|
...
| Manual Local Intake | Supported | Supported | 既に手元にあるファイルも手動取り込み可能 |
...
| Provider affiliation / partnership | None | None | Non-affiliation文必須 |
